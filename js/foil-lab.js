(() => {
  ...
  const RARITY_DEFAULTS = {
    ...
    galaxy: { baseOpacity: 1, baseBrightness: 1.12, baseContrast: 2.13, baseSaturation: 2.4, effectOpacity: .52, effectBrightness: .78, effectContrast: 1.46, effectSaturation: 2.05, patternScale: 136, textureScale: 150, angle: 313, maskCenter: .2, maskMid: .19, maskFade: 99, glowSize: 58, glowOpacity: 72, spotlightOpacity: .22, spotlightSize: 122, parallax: 1.4, tilt: 20, animationSpeed: 3.5, impactDelay: 2.08, burstDuration: 2.3, particleDuration: 3.4, shockDuration: 1.8, impactDuration: 2.1, backDelay: 2.15, backDuration: 2.05, impactAlpha: .86, burstScale: 2.25, shockScale: 3.35, frontParticleCount: 44, frontParticleSize: 11.5, frontParticleDistance: 540, backParticleCount: 18, backParticleSize: 32, backParticleDistance: 640, impactRayCount: 36, preludeDuration: 1.65, flashDuration: 1.86, preludeBeamWidth: 40, preludeBeamGlow: 78, preludeRotation: 138, screenFlashOpacity: .82, cardFlashOpacity: 1, primary: "#358dc6", secondary: "#b63fb7", accent: "#6632c7", blendMode: "screen", impactPrimary: "#aa73ff", impactSecondary: "#48e8ff" },
